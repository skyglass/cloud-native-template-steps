...
public class OrderSagasConfiguration {
  ...
  @Bean
  public OrderService orderSagaService(OrderRepository orderRepository, SagaInstanceFactory sagaInstanceFactory, CreateOrderSaga createOrderSaga) {
    return new OrderService(orderRepository, sagaInstanceFactory, createOrderSaga);
  }

  @Bean
  public CreateOrderSaga createOrderSaga(io.eventuate.examples.tram.sagas.ordersandcustomers.orders.domain.OrderService orderService, CustomerServiceProxy customerService) {
